...
prototxt_file = file_path + './checkpoints/Resnet_SSD_deploy.prototxt'
caffemodel_file = file_path + './checkpoints/Res10_300x300_SSD_iter_140000.caffemodel'
...
while True:
    ...
    cv.putText(frame, text, (15, int(origin_h * 0.92)),
