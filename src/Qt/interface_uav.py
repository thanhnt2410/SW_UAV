...
"background-color: rgb(252, 175, 62);")
        ...
        self.verticalLayout_25 = QtWidgets.QVBoxLayout(self.groupBoxMapConfig_2)
        ...
        self.tableWidgetAlgorithmComparison.setRowCount(8)
        self.tableWidgetAlgorithmComparison.setColumnCount(9)
